  ...
  "a fully successful response" should {
    "contain success entries for each service" in {
      val sut = new StartupServiceImpl[TestF](dummyConnector(),
                                              ...
                                              enableChildBenefitSatisfactionSurvey                           = false,
                                              enablePayeAsYouEarnCustomerSatisfactionSurvey                 = false,
                                              enableSelfAssessmentCustomerSatisfactionSurvey                = false,
                                              enableSelfAssessmentPaymentsCustomerSatisfactionSurvey        = false,
                                              enableTaxCreditsCustomerSatisfactionSurvey                    = false,
                                              enableHelpToSaveCustomerSatisfactionSurvey                    = false,
                                              enableMessagesCustomerSatisfactionSurvey                      = false,
                                              enableFormTrackerCustomerSatisfactionSurvey                   = false,
                                              enableTaxCalculatorCustomerSatisfactionSurvey                 = false,
                                              enableYourDetailsCustomerSatisfactionSurvey                   = false,
                                              enableSigningInSatisfactionSurvey                             = false,
      ...
      (result \ "feature").get
        ...
        FeatureFlag("customerSatisfactionSurvey.childBenefit", enabled                    = false),
        FeatureFlag("customerSatisfactionSurvey.payeAsYouEarn", enabled                  = false),
        FeatureFlag("customerSatisfactionSurvey.selfAssessment", enabled                 = false),
        FeatureFlag("customerSatisfactionSurvey.selfAssessmentPayments", enabled         = false),
        FeatureFlag("customerSatisfactionSurvey.taxCredits", enabled                     = false),
        FeatureFlag("customerSatisfactionSurvey.helpToSave", enabled                     = false),
        FeatureFlag("customerSatisfactionSurvey.messages", enabled                       = false),
        FeatureFlag("customerSatisfactionSurvey.formTracker", enabled                    = false),
        FeatureFlag("customerSatisfactionSurvey.taxCalculator", enabled                  = false),
        FeatureFlag("customerSatisfactionSurvey.yourDetails", enabled                    = false),
        FeatureFlag("customerSatisfactionSurvey.signingIntoTheApp", enabled              = false),
