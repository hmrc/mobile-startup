...
class BaseISpec
  ...
  def config: Map[String, Any] =
    Map(
      ...
      "feature.customerSatisfactionSurvey.helpToSave"                   -> true,
      "feature.customerSatisfactionSurvey.messages"                     -> true,
      "feature.customerSatisfactionSurvey.formTracker"                  -> true,
      "feature.customerSatisfactionSurvey.taxCalculator"                -> true,
      "feature.customerSatisfactionSurvey.yourDetails"                  -> true,
      "feature.customerSatisfactionSurvey.signingIntoTheApp"            -> true,
