...
class BaseISpec
  ...
  def config: Map[String, Any] =
    Map(
      ...
      "feature.taxCreditsCustomerSatisfactionSurveyAdverts"             -> true,
      "feature.helpToSaveCustomerSatisfactionSurveyAdverts"             -> true,
      "feature.messagesCustomerSatisfactionSurveyAdverts"               -> true,
      ...
      "feature.payeYourEmploymentIncomeChart"                           -> true,
