...
class LiveStartupControllerISpec extends BaseISpec {
  ...
  "GET /startup" should {
    ...
    "return startup details" in {
      ...
      (response.json \ "feature" \ 18 \ "enabled").as[Boolean]              shouldBe true
      (response.json \ "feature" \ 19 \ "name").as[String]                  shouldBe "enableUniversalPensionTaxCreditBanner"
      ...
      (response.json \ "feature" \ 21 \ "name").as[String]                  shouldBe "devEnableChildBenefitMVP"
