...
class LiveStartupControllerISpec extends BaseISpec {
  ...
  "GET /startup" should {
    ...
    "return startup details" in {
      ...
      (response.json \ "feature" \ 18 \ "name").as[String]                  shouldBe "enableTaxCreditShuttering"
      (response.json \ "feature" \ 18 \ "enabled").as[Boolean]              shouldBe false
      (response.json \ "feature" \ 19 \ "name").as[String]                  shouldBe "enableUniversalPensionTaxCredit"
      (response.json \ "feature" \ 19 \ "enabled").as[Boolean]              shouldBe false
      (response.json \ "feature" \ 20 \ "name").as[String]                  shouldBe "enableHtsBanner"
      ...
      (response.json \ "urls" \ 19 \ "name").as[String]                     shouldBe "incomeTaxGeneralEnquiriesUrl"
      (response.json \ "urls" \ 19 \ "url").as[String]                      shouldBe "/incomeTaxGeneralEnquiriesUrl"
      (response.json \ "urls" \ 20 \ "name").as[String]                     shouldBe "incomeTaxGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 20 \ "url").as[String]                      shouldBe "/incomeTaxGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 21 \ "name").as[String]                     shouldBe "learnAboutCallChargesUrl"
      (response.json \ "urls" \ 21 \ "url").as[String]                      shouldBe "/learnAboutCallChargesUrl"
      (response.json \ "urls" \ 22 \ "name").as[String]                     shouldBe "learnAboutCallChargesUrlCy"
      (response.json \ "urls" \ 22 \ "url").as[String]                      shouldBe "/learnAboutCallChargesUrlCy"
      (response.json \ "urls" \ 23 \ "name").as[String]                     shouldBe "statePensionAgeUrl"
      (response.json \ "urls" \ 23 \ "url").as[String]                      shouldBe "/statePensionAgeUrl"
      (response.json \ "urls" \ 24 \ "name").as[String]                     shouldBe "tcNationalInsuranceRatesLettersUrl"
      (response.json \ "urls" \ 24 \ "url").as[String]                      shouldBe "/tcNationalInsuranceRatesLettersUrl"
      (response.json \ "urls" \ 25 \ "name").as[String]                     shouldBe "tcNationalInsuranceRatesLettersUrlCy"
      (response.json \ "urls" \ 25 \ "url").as[String]                      shouldBe "/tcNationalInsuranceRatesLettersUrlCy"
      (response.json \ "urls" \ 26 \ "name").as[String]                     shouldBe "tcPersonalAllowanceUrl"
      (response.json \ "urls" \ 26 \ "url").as[String]                      shouldBe "/tcPersonalAllowanceUrl"
      (response.json \ "urls" \ 27 \ "name").as[String]                     shouldBe "tcPersonalAllowanceUrlCy"
      (response.json \ "urls" \ 27 \ "url").as[String]                      shouldBe "/tcPersonalAllowanceUrlCy"
      (response.json \ "urls" \ 28 \ "name").as[String]                     shouldBe "scottishIncomeTaxUrl"
      (response.json \ "urls" \ 28 \ "url").as[String]                      shouldBe "/scottishIncomeTaxUrl"
      (response.json \ "urls" \ 29 \ "name").as[String]                     shouldBe "scottishIncomeTaxUrlCy"
      (response.json \ "urls" \ 29 \ "url").as[String]                      shouldBe "/scottishIncomeTaxUrlCy"
      (response.json \ "urls" \ 30 \ "name").as[String]                     shouldBe "cbTaxChargeUrl"
      (response.json \ "urls" \ 30 \ "url").as[String]                      shouldBe "/cbTaxChargeUrl"
      (response.json \ "urls" \ 31 \ "name").as[String]                     shouldBe "cbTaxChargeUrlCy"
      (response.json \ "urls" \ 31 \ "url").as[String]                      shouldBe "/cbTaxChargeUrlCy"
      (response.json \ "urls" \ 32 \ "name").as[String]                     shouldBe "selfAssessmentHelpAppealingPenaltiesUrl"
      (response.json \ "urls" \ 32 \ "url").as[String]                      shouldBe "/selfAssessmentHelpAppealingPenaltiesUrl"
      (response.json \ "urls" \ 33 \ "name").as[String]                     shouldBe "selfAssessmentHelpAppealingPenaltiesUrlCy"
      (response.json \ "urls" \ 33 \ "url").as[String]                      shouldBe "/selfAssessmentHelpAppealingPenaltiesUrlCy"
      (response.json \ "urls" \ 34 \ "name").as[String]                     shouldBe "addMissingTaxableIncomeUrl"
      (response.json \ "urls" \ 34 \ "url").as[String]                      shouldBe "/addMissingTaxableIncomeUrl"
      (response.json \ "urls" \ 35 \ "name").as[String]                     shouldBe "helpToSaveGeneralEnquiriesUrl"
      (response.json \ "urls" \ 35 \ "url").as[String]                      shouldBe "/helpToSaveGeneralEnquiriesUrl"
      (response.json \ "urls" \ 36 \ "name").as[String]                     shouldBe "helpToSaveGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 36 \ "url").as[String]                      shouldBe "/helpToSaveGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 37 \ "name").as[String]                     shouldBe "helpToSaveDigitalAssistantUrl"
      (response.json \ "urls" \ 37 \ "url").as[String]                      shouldBe "/helpToSaveDigitalAssistantUrl"
      (response.json \ "urls" \ 38 \ "name").as[String]                     shouldBe "selfAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 38 \ "url").as[String]                      shouldBe "/selfAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 39 \ "name").as[String]                     shouldBe "selfAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 39 \ "url").as[String]                      shouldBe "/selfAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 40 \ "name").as[String]                     shouldBe "simpleAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 40 \ "url").as[String]                      shouldBe "/simpleAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 41 \ "name").as[String]                     shouldBe "simpleAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 41 \ "url").as[String]                      shouldBe "/simpleAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 42 \ "name").as[String]                     shouldBe "cbGeneralEnquiriesUrl"
      (response.json \ "urls" \ 42 \ "url").as[String]                      shouldBe "/cbGeneralEnquiriesUrl"
      (response.json \ "urls" \ 43 \ "name").as[String]                     shouldBe "cbGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 43 \ "url").as[String]                      shouldBe "/cbGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 44 \ "name").as[String]                     shouldBe "taxCreditsGeneralEnquiriesUrl"
      (response.json \ "urls" \ 44 \ "url").as[String]                      shouldBe "/taxCreditsGeneralEnquiriesUrl"
      (response.json \ "urls" \ 45 \ "name").as[String]                     shouldBe "taxCreditsGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 45 \ "url").as[String]                      shouldBe "/taxCreditsGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 46 \ "name").as[String]                     shouldBe "otherTaxesGeneralEnquiriesUrl"
      (response.json \ "urls" \ 46 \ "url").as[String]                      shouldBe "/otherTaxesGeneralEnquiriesUrl"
      (response.json \ "urls" \ 47 \ "name").as[String]                     shouldBe "otherTaxesGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 47 \ "url").as[String]                      shouldBe "/otherTaxesGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 48 \ "name").as[String]                     shouldBe "findRepaymentPlanUrl"
      (response.json \ "urls" \ 48 \ "url").as[String]                      shouldBe "/findRepaymentPlanUrl"
      (response.json \ "urls" \ 49 \ "name").as[String]                     shouldBe "findRepaymentPlanUrlCy"
      (response.json \ "urls" \ 49 \ "url").as[String]                      shouldBe "/findRepaymentPlanUrlCy"
      (response.json \ "urls" \ 50 \ "name").as[String]                     shouldBe "pensionAnnualAllowanceUrl"
      (response.json \ "urls" \ 50 \ "url").as[String]                      shouldBe "/pensionAnnualAllowanceUrl"
      (response.json \ "urls" \ 51 \ "name").as[String]                     shouldBe "pensionAnnualAllowanceUrlCy"
      (response.json \ "urls" \ 51 \ "url").as[String]                      shouldBe "/pensionAnnualAllowanceUrlCy"
      (response.json \ "urls" \ 52 \ "name").as[String]                     shouldBe "childBenefitDigitalAssistantUrl"
      (response.json \ "urls" \ 52 \ "url").as[String]                      shouldBe "/childBenefitDigitalAssistantUrl"
      (response.json \ "urls" \ 53 \ "name").as[String]                     shouldBe "childBenefitDigitalAssistantUrlCy"
      (response.json \ "urls" \ 53 \ "url").as[String]                      shouldBe "/childBenefitDigitalAssistantUrlCy"
      (response.json \ "urls" \ 54 \ "name").as[String]                     shouldBe "incomeTaxDigitalAssistantUrl"
      (response.json \ "urls" \ 54 \ "url").as[String]                      shouldBe "/incomeTaxDigitalAssistantUrl"
      (response.json \ "urls" \ 55 \ "name").as[String]                     shouldBe "incomeTaxDigitalAssistantUrlCy"
      (response.json \ "urls" \ 55 \ "url").as[String]                      shouldBe "/incomeTaxDigitalAssistantUrlCy"
      (response.json \ "urls" \ 56 \ "name").as[String]                     shouldBe "selfAssessmentDigitalAssistantUrl"
      (response.json \ "urls" \ 56 \ "url").as[String]                      shouldBe "/selfAssessmentDigitalAssistantUrl"
      (response.json \ "urls" \ 57 \ "name").as[String]                     shouldBe "selfAssessmentDigitalAssistantUrlCy"
      (response.json \ "urls" \ 57 \ "url").as[String]                      shouldBe "/selfAssessmentDigitalAssistantUrlCy"
      (response.json \ "urls" \ 58 \ "name").as[String]                     shouldBe "taxCreditsDigitalAssistantUrl"
      (response.json \ "urls" \ 58 \ "url").as[String]                      shouldBe "/taxCreditsDigitalAssistantUrl"
      (response.json \ "urls" \ 59 \ "name").as[String]                     shouldBe "taxCreditsDigitalAssistantUrlCy"
      (response.json \ "urls" \ 59 \ "url").as[String]                      shouldBe "/taxCreditsDigitalAssistantUrlCy"
      (response.json \ "urls" \ 60 \ "name").as[String]                     shouldBe "tcStateBenefitsUrl"
      (response.json \ "urls" \ 60 \ "url").as[String]                      shouldBe "/tcStateBenefitsUrl"
      (response.json \ "urls" \ 61 \ "name").as[String]                     shouldBe "tcStateBenefitsUrlCy"
      (response.json \ "urls" \ 61 \ "url").as[String]                      shouldBe "/tcStateBenefitsUrlCy"
      (response.json \ "urls" \ 62 \ "name").as[String]                     shouldBe "tcCompanyBenefitsUrl"
      (response.json \ "urls" \ 62 \ "url").as[String]                      shouldBe "/tcCompanyBenefitsUrl"
      (response.json \ "urls" \ 63 \ "name").as[String]                     shouldBe "tcCompanyBenefitsUrlCy"
      (response.json \ "urls" \ 63 \ "url").as[String]                      shouldBe "/tcCompanyBenefitsUrlCy"
    }
