...
class LiveStartupControllerISpec extends BaseISpec {
  ...
  "GET /startup" should {
    ...
    "return startup details" in {
      ...
      (response.json \ "urls" \ 20 \ "name").as[String]                     shouldBe "learnAboutCallChargesUrl"
      (response.json \ "urls" \ 20 \ "url").as[String]                      shouldBe "/learnAboutCallChargesUrl"
      (response.json \ "urls" \ 21 \ "name").as[String]                     shouldBe "learnAboutCallChargesUrlCy"
      (response.json \ "urls" \ 21 \ "url").as[String]                      shouldBe "/learnAboutCallChargesUrlCy"
      (response.json \ "urls" \ 22 \ "name").as[String]                     shouldBe "statePensionAgeUrl"
      (response.json \ "urls" \ 22 \ "url").as[String]                      shouldBe "/statePensionAgeUrl"
      (response.json \ "urls" \ 23 \ "name").as[String]                     shouldBe "tcNationalInsuranceRatesLettersUrl"
      (response.json \ "urls" \ 23 \ "url").as[String]                      shouldBe "/tcNationalInsuranceRatesLettersUrl"
      (response.json \ "urls" \ 24 \ "name").as[String]                     shouldBe "tcNationalInsuranceRatesLettersUrlCy"
      (response.json \ "urls" \ 24 \ "url").as[String]                      shouldBe "/tcNationalInsuranceRatesLettersUrlCy"
      (response.json \ "urls" \ 25 \ "name").as[String]                     shouldBe "tcPersonalAllowanceUrl"
      (response.json \ "urls" \ 25 \ "url").as[String]                      shouldBe "/tcPersonalAllowanceUrl"
      (response.json \ "urls" \ 26 \ "name").as[String]                     shouldBe "tcPersonalAllowanceUrlCy"
      (response.json \ "urls" \ 26 \ "url").as[String]                      shouldBe "/tcPersonalAllowanceUrlCy"
      (response.json \ "urls" \ 27 \ "name").as[String]                     shouldBe "scottishIncomeTaxUrl"
      (response.json \ "urls" \ 27 \ "url").as[String]                      shouldBe "/scottishIncomeTaxUrl"
      (response.json \ "urls" \ 28 \ "name").as[String]                     shouldBe "scottishIncomeTaxUrlCy"
      (response.json \ "urls" \ 28 \ "url").as[String]                      shouldBe "/scottishIncomeTaxUrlCy"
      (response.json \ "urls" \ 29 \ "name").as[String]                     shouldBe "cbTaxChargeUrl"
      (response.json \ "urls" \ 29 \ "url").as[String]                      shouldBe "/cbTaxChargeUrl"
      (response.json \ "urls" \ 30 \ "name").as[String]                     shouldBe "cbTaxChargeUrlCy"
      (response.json \ "urls" \ 30 \ "url").as[String]                      shouldBe "/cbTaxChargeUrlCy"
      (response.json \ "urls" \ 31 \ "name").as[String]                     shouldBe "selfAssessmentHelpAppealingPenaltiesUrl"
      (response.json \ "urls" \ 31 \ "url").as[String]                      shouldBe "/selfAssessmentHelpAppealingPenaltiesUrl"
      (response.json \ "urls" \ 32 \ "name").as[String]                     shouldBe "selfAssessmentHelpAppealingPenaltiesUrlCy"
      (response.json \ "urls" \ 32 \ "url").as[String]                      shouldBe "/selfAssessmentHelpAppealingPenaltiesUrlCy"
      (response.json \ "urls" \ 33 \ "name").as[String]                     shouldBe "addMissingTaxableIncomeUrl"
      (response.json \ "urls" \ 33 \ "url").as[String]                      shouldBe "/addMissingTaxableIncomeUrl"
      (response.json \ "urls" \ 34 \ "name").as[String]                     shouldBe "helpToSaveGeneralEnquiriesUrl"
      (response.json \ "urls" \ 34 \ "url").as[String]                      shouldBe "/helpToSaveGeneralEnquiriesUrl"
      (response.json \ "urls" \ 35 \ "name").as[String]                     shouldBe "helpToSaveGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 35 \ "url").as[String]                      shouldBe "/helpToSaveGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 36 \ "name").as[String]                     shouldBe "helpToSaveDigitalAssistantUrl"
      (response.json \ "urls" \ 36 \ "url").as[String]                      shouldBe "/helpToSaveDigitalAssistantUrl"
      (response.json \ "urls" \ 37 \ "name").as[String]                     shouldBe "selfAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 37 \ "url").as[String]                      shouldBe "/selfAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 38 \ "name").as[String]                     shouldBe "selfAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 38 \ "url").as[String]                      shouldBe "/selfAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 39 \ "name").as[String]                     shouldBe "simpleAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 39 \ "url").as[String]                      shouldBe "/simpleAssessmentGeneralEnquiriesUrl"
      (response.json \ "urls" \ 40 \ "name").as[String]                     shouldBe "simpleAssessmentGeneralEnquiriesUrlCy"
      (response.json \ "urls" \ 40 \ "url").as[String]                      shouldBe "/simpleAssessmentGeneralEnquiriesUrlCy"
