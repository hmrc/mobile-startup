...
class LiveStartupService @Inject() (
  ...
  @Named("feature.customerSatisfactionSurvey.childBenefit") enableChildBenefitSatisfactionSurvey:                                                   Boolean,
  @Named("feature.customerSatisfactionSurvey.payeAsYouEarn") enablePayeAsYouEarnCustomerSatisfactionSurvey:                                       Boolean,
  @Named("feature.customerSatisfactionSurvey.selfAssessment") enableSelfAssessmentCustomerSatisfactionSurvey:                                     Boolean,
  @Named("feature.customerSatisfactionSurvey.selfAssessmentPayments") enableSelfAssessmentPaymentsCustomerSatisfactionSurvey:                     Boolean,
  @Named("feature.customerSatisfactionSurvey.taxCredits") enableTaxCreditsCustomerSatisfactionSurvey:                                             Boolean,
  @Named("feature.customerSatisfactionSurvey.helpToSave") enableHelpToSaveCustomerSatisfactionSurvey:                                             Boolean,
  @Named("feature.customerSatisfactionSurvey.messages") enableMessagesCustomerSatisfactionSurvey:                                                 Boolean,
  @Named("feature.customerSatisfactionSurvey.formTracker") enableFormTrackerCustomerSatisfactionSurvey:                                           Boolean,
  @Named("feature.customerSatisfactionSurvey.taxCalculator") enableTaxCalculatorCustomerSatisfactionSurvey:                                       Boolean,
  @Named("feature.customerSatisfactionSurvey.yourDetails") enableYourDetailsCustomerSatisfactionSurvey:                                           Boolean,
  @Named("feature.customerSatisfactionSurvey.signingIntoTheApp") enableSigningInSatisfactionSurvey:                                               Boolean,
  ...
  @Named("feature.disableYourEmploymentIncomeChart") disableYourEmploymentIncomeChart:                                                            Boolean
    ...
    extends StartupServiceImpl[Future](connector,
                                       ...
                                       niSummaryUrl,
                                       niContributionsUrl,
                                       enableChildBenefitSatisfactionSurvey,
                                       enablePayeAsYouEarnCustomerSatisfactionSurvey,
                                       enableSelfAssessmentCustomerSatisfactionSurvey,
                                       enableSelfAssessmentPaymentsCustomerSatisfactionSurvey,
                                       enableTaxCreditsCustomerSatisfactionSurvey,
                                       enableHelpToSaveCustomerSatisfactionSurvey,
                                       enableMessagesCustomerSatisfactionSurvey,
                                       enableFormTrackerCustomerSatisfactionSurvey,
                                       enableTaxCalculatorCustomerSatisfactionSurvey,
                                       enableYourDetailsCustomerSatisfactionSurvey,
                                       enableSigningInSatisfactionSurvey,
