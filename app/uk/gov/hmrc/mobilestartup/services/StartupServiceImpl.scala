...
class StartupServiceImpl[F[_]] @Inject() (
  ...
  enableChildBenefitSatisfactionSurvey:                                  Boolean,
  enablePayeAsYouEarnCustomerSatisfactionSurvey:                        Boolean,
  enableSelfAssessmentCustomerSatisfactionSurvey:                       Boolean,
  enableSelfAssessmentPaymentsCustomerSatisfactionSurvey:               Boolean,
  enableTaxCreditsCustomerSatisfactionSurvey:                           Boolean,
  enableHelpToSaveCustomerSatisfactionSurvey:                           Boolean,
  enableMessagesCustomerSatisfactionSurvey:                             Boolean,
  enableFormTrackerCustomerSatisfactionSurvey:                          Boolean,
  enableTaxCalculatorCustomerSatisfactionSurvey:                        Boolean,
  enableYourDetailsCustomerSatisfactionSurvey:                          Boolean,
  enableSigningInSatisfactionSurvey:                                    Boolean,
  ...
  private val featureFlags: JsObject =
    obj(
      "feature" -> List(
        ...
        FeatureFlag("customerSatisfactionSurvey.childBenefit", enableChildBenefitSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.payeAsYouEarn", enablePayeAsYouEarnCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.selfAssessment",
          enableSelfAssessmentCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.selfAssessmentPayments",
          enableSelfAssessmentPaymentsCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.taxCredits", enableTaxCreditsCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.helpToSave", enableHelpToSaveCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.messages", enableMessagesCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.formTracker", enableFormTrackerCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.taxCalculator",
          enableTaxCalculatorCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.yourDetails", enableYourDetailsCustomerSatisfactionSurvey),
        FeatureFlag("customerSatisfactionSurvey.signingIntoTheApp", enableSigningInSatisfactionSurvey),
