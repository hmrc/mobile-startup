...
class GuiceModule @Inject() (
  ...
  override def configure(): Unit = {
    ...
    bindConfigBoolean("feature.customerSatisfactionSurvey.helpToSave")
    bindConfigBoolean("feature.customerSatisfactionSurvey.messages")
    bindConfigBoolean("feature.customerSatisfactionSurvey.formTracker")
    bindConfigBoolean("feature.customerSatisfactionSurvey.taxCalculator")
    bindConfigBoolean("feature.customerSatisfactionSurvey.yourDetails")
    bindConfigBoolean("feature.customerSatisfactionSurvey.signingIntoTheApp")
