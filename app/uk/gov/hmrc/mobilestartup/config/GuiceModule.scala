...
class GuiceModule @Inject() (
  ...
  override def configure(): Unit = {
    ...
    bindConfigOptionalString("incomeTaxGeneralEnquiriesUrlCy", "url.incomeTaxGeneralEnquiriesUrlCy")
    ...
    bindConfigOptionalString("cbGeneralEnquiriesUrl", "url.cbGeneralEnquiriesUrl")
    bindConfigOptionalString("cbGeneralEnquiriesUrlCy", "url.cbGeneralEnquiriesUrlCy")
    bindConfigOptionalString("incomeTaxGeneralEnquiriesUrl", "url.incomeTaxGeneralEnquiriesUrl")
    bindConfigOptionalString("incomeTaxGeneralEnquiriesUrlCy", "url.incomeTaxGeneralEnquiriesUrlCy")
    bindConfigOptionalString("taxCreditsGeneralEnquiriesUrl", "url.taxCreditsGeneralEnquiriesUrl")
    ...
    bindConfigString("serviceFlagStartTime", "time.serviceFlagStartTime")
    bindConfigString("serviceFlagEndTime", "time.serviceFlagEndTime")
    bind(classOf[String])
